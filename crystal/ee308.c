...
void init_timer(void)
{
	//_T1IP = 4;	// set Timer1 priority, (4 is the default value)
  	T2CONbits.TCKPS0 = 1;
	T2CONbits.TCKPS1 = 1;	// prescaler set to 256 
    T2CONbits.TCS = 1;
	...
	TMR2 = 0x0000;
	PR2	 = 1547;		// set timer1 period to 1548 -> f = 2e6/256/1548 = 4Hz
...
{
    unsigned int i;
    volatile unsigned char LCD_data[2][16] = {"PIC24 Board v2.2", "Counter        0"};
